...
#pragma warning disable XSG006 // Reflection fallback used
            public object? Item { get; set; }
#pragma warning restore XSG006 // Reflection fallback used
        }
        ...
        public void Polymorphic_Override_Works_WhenPreferOptionsOverAttributesIsTrue()
        {
            ...
            XElement? itemA = xml.Element("ItemA");
            Assert.NotNull(itemA); // fluent assertions' NotNull does not inform the type checker that itemA is not null.
            itemA.Element("PropA")?.Value.Should().Be("Alpha");
