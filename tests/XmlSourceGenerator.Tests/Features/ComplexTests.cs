...
namespace XmlSourceGenerator.Tests.Integration
{
    ...
    public class ComplexTests
    {
        ...
        public void TestRecursiveList()
        {
            ...
            var child = restored.Children[0];
            Assert.Equal("Level1_A", child.Name);
            Assert.NotNull(child.Children);
            Assert.Equal("Level2_A", Assert.Single(child.Children).Name);
        }
        ...
        public void TestInheritanceRecursion()
        {
            ...
            Assert.NotNull(restored.Peers);
            Assert.Equal("Peer1", Assert.Single(restored.Peers).BaseName);
        }
    }
}
