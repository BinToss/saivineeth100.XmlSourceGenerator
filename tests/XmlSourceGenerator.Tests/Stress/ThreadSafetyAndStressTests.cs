...
namespace XmlSourceGenerator.Tests.Stress
{
    ...
    public class ThreadSafetyAndStressTests
    {
        ...
        public async Task ConcurrentSerialization_ShouldProduceCorrectResults()
        {
            ...
            // Verify unique IDs
            var ids = totalElements.Select(x => x.Element("Id")?.Value is string s ? int.Parse(s) : -1).ToList();
        ...
        public void DeepObjectGraph_10Levels_ShouldDeserialize()
        {
            ...
            var dl9 = entity.Child.Child.Child?.Child?.Child?.Child?.Child?.Child;
            Assert.NotNull(dl9);
            dl9.Child.Should().NotBeNull();
            dl9.Child.Level10Data.Should().Be("L10");
        }
        ...
        private void VerifyDeepGraph(DeepLevel1 entity)
        {
            ...
            Assert.NotNull(entity.Child.Child);
            Assert.NotNull(entity.Child.Child.Child);
            Assert.NotNull(entity.Child.Child.Child.Child);
            var dl6 = entity.Child.Child.Child.Child.Child;
            Assert.NotNull(dl6);
            Assert.NotNull(dl6.Child);
            Assert.NotNull(dl6.Child.Child);
            Assert.NotNull(dl6.Child.Child.Child);
            Assert.NotNull(dl6.Child.Child.Child.Child);
            ...
            dl6.Level6Data.Should().Be("Data6");
            dl6.Child.Level7Data.Should().Be("Data7");
            dl6.Child.Child.Level8Data.Should().Be("Data8");
            dl6.Child.Child.Child.Level9Data.Should().Be("Data9");
            dl6.Child.Child.Child.Child.Level10Data.Should().Be("Data10");
        }
